...
HD_PWD='C:/Users/farha/UART_F/UART_F.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UARTLoopback.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UARTLoopback.tcl
